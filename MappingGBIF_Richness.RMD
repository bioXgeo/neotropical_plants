...
# Read in Data
```{r}
NorthAndes_GBIF_plant_occ <- read.csv(file.path(data_path,"TropAndes_GBIF_plant_occ.csv"))
NorthAndes_GBIF_frugivore_occ <- read.csv(file.path(data_path,"TropAndes_GBIF_frugivore_occ.csv"))
```
...
```{r}
plants.sf <- st_as_sf(NorthAndes_GBIF_plant_occ, coords = c("decimalLongitude", "decimalLatitude"), crs = 4326)
```

```{r}
frugivores.sf <- st_as_sf(NorthAndes_GBIF_frugivore_occ, coords = c("decimalLongitude", "decimalLatitude"), crs = 4326)
```
