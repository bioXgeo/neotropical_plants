...
# Read in Data
```{r}
plant_cellRichness_1km <- read.csv(file.path(data_path_L2,"TropicalAndes_plantRichness_1km.csv"))
frugivore_cellRichness_1km <- read.csv(file.path(data_path_L2,"TropicalAndes_frugivoreRichness_1km.csv"))
