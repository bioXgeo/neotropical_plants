...
```{r}
# Add "Plants" label above the legend
all_plant_richness_plots_labeled <- all_plant_richness_plots + theme(legend.title = element_text("Plants\n S"))
all_plant_richness_plots_labeled
ggsave("plant_richness_plots.png", all_plant_richness_plots_labeled, path = figure_path, width = 18, height = 8, units = "in")
```
...
ggsave("frugivore_richness_plots.png", all_frugivore_richness_plots_labeled, path = figure_path, width = 11, height = 8, units = "in")
```
