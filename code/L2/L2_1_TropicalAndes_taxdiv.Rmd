...
## Richness maps
```{r}
all_plant_richness_plots <- ggpubr::ggarrange(#plantgridRichTA_1km, plantgridRichTA_5km, 
                                              #plantgridRichTA_10km, 
                                              plantgridRichTA_25km,
                                              plantgridRichTA_50km, plantgridRichTA_75km,
                                              plantgridRichTA_100km,
                                              ncol = 4, nrow = 1,
                                              labels = c("25 km", "50 km", "75 km", "100 km"),
...
```{r}
all_frugivore_richness_plots <- ggpubr::ggarrange(#frugivoregridRichTA_1km, frugivoregridRichTA_5km, 
                                              #frugivoregridRichTA_10km, 
