#title: "Tropical Andes Functional diversity maps for plants and Frugivores"
...
ggsave("all_frugivore_fdis_plots3.png", all_frugivore_fdis_plots_labeled, path = figure_path, width = 16, height = 10, units = "in", dpi=1000)
...
ggsave("all_mammal_fdis_plots3.png", all_mammal_fdis_plots_labeled, path = figure_path, width = 16, height = 10, units = "in", dpi=1000)
...
ggsave("all_bird_fdis_plots3.png", all_bird_fdis_plots_labeled, path = figure_path, width = 16, height = 10, units = "in", dpi=1000)
...
ggsave("all_plant_fdis_plots3.png", all_plant_fdis_plots_labeled, path = figure_path, width = 16, height = 10, units = "in", dpi=1000)
