...
# 100km
comparison_100km <- div_comparison(plant_cell_FD_100km, mammal_cell_FD_100km, bird_cell_FD_100km, 100) 
...
# 75 km
comparison_75km <- div_comparison(plant_cell_FD_75km, mammal_cell_FD_75km, bird_cell_FD_75km, 75)
...
# 50 km
comparison_50km <- div_comparison(plant_cell_FD_50km, mammal_cell_FD_50km, bird_cell_FD_50km, 50)
...
# 25 km
comparison_25km <- div_comparison(plant_cell_FD_25km, mammal_cell_FD_25km, bird_cell_FD_25km, 25)
...
# 10 km
comparison_10km <- div_comparison(plant_cell_FD_10km, mammal_cell_FD_10km, bird_cell_FD_10km, 10)
...
# 5 km
comparison_5km <- div_comparison(plant_cell_FD_5km, mammal_cell_FD_5km, bird_cell_FD_5km, 5)
...
ggsave('all_taxa_FDis_plots.png', all_taxa_FDis_plots, path = all_data_figure_path, width = 13, height = 8, units = "in", dpi=1000)


#### GAMs ####

# 100km
comparison_100km_gam <- div_comparison_gam(plant_cell_FD_100km, mammal_cell_FD_100km, bird_cell_FD_100km, 100)
...
# 75 km
comparison_75km_gam <- div_comparison_gam(plant_cell_FD_75km, mammal_cell_FD_75km, bird_cell_FD_75km, 75)
...
# 50 km
comparison_50km_gam <- div_comparison_gam(plant_cell_FD_50km, mammal_cell_FD_50km, bird_cell_FD_50km, 50)
...
# 25 km
comparison_25km_gam <- div_comparison_gam(plant_cell_FD_25km, mammal_cell_FD_25km, bird_cell_FD_25km, 25)
...
# 10 km
comparison_10km_gam <- div_comparison_gam(plant_cell_FD_10km, mammal_cell_FD_10km, bird_cell_FD_10km, 10)
...
# 5 km
comparison_5km_gam <- div_comparison_gam(plant_cell_FD_5km, mammal_cell_FD_5km, bird_cell_FD_5km, 5)
...
ggsave('all_taxa_FDis_gam_plots.png', all_taxa_FDis_gam_plots, path = all_data_figure_path, width = 13, height = 8, units = "in", dpi=1000)
...
# 100km
cutoff_comparison_100km <- div_comparison(plant_cutoff_cell_FD_100km, mammal_cutoff_cell_FD_100km, bird_cutoff_cell_FD_100km, 100) 

cutoff_comparison_100km_plot <- cutoff_comparison_100km$plot
(cutoff_comparison_100km_plot <- cutoff_comparison_100km_plot + ylab('Frugivore FDis by cell') + xlab('Plant FDis by cell') + theme(axis.title.y = element_blank(),axis.text.y = element_blank(), axis.ticks.y = element_blank(), axis.line.y = element_blank()) +   annotate("text", x = 0.4, y = 0.55, label = paste('Bird R² =', round(cutoff_comparison_100km$r2_df$r2[2], 3)), size=5) + annotate("text", x = 0.4, y = 0.65, label = paste('Mammal R² =', round(cutoff_comparison_100km$r2_df$r2[1], 3)), size=5) + theme(plot.title = element_text(face = "bold", hjust=0.5, size=16)))
...
# 75 km
cutoff_comparison_75km <- div_comparison(plant_cutoff_cell_FD_75km, mammal_cutoff_cell_FD_75km, bird_cutoff_cell_FD_75km, 75) 

cutoff_comparison_75km_plot <- cutoff_comparison_75km$plot
(cutoff_comparison_75km_plot <- cutoff_comparison_75km_plot + ylab('Frugivore FDis by cell') + xlab('Plant FDis by cell') + theme(axis.title.y = element_blank(),axis.text.y = element_blank(), axis.ticks.y = element_blank(), axis.line.y = element_blank()) +   annotate("text", x = 0.4, y = 0.55, label = paste('Bird R² =', round(cutoff_comparison_75km$r2_df$r2[2], 3)), size=5) + annotate("text", x = 0.4, y = 0.65, label = paste('Mammal R² =', round(cutoff_comparison_75km$r2_df$r2[1], 3)), size=5) + theme(plot.title = element_text(face = "bold", hjust=0.5, size=16)))
...
# 50 km
cutoff_comparison_50km <- div_comparison(plant_cutoff_cell_FD_50km, mammal_cutoff_cell_FD_50km, bird_cutoff_cell_FD_50km, 50) 

cutoff_comparison_50km_plot <- cutoff_comparison_50km$plot
(cutoff_comparison_50km_plot <- cutoff_comparison_50km_plot + ylab('Frugivore FDis by cell') + xlab('Plant FDis by cell') + theme(axis.title.y = element_blank(),axis.text.y = element_blank(), axis.ticks.y = element_blank(), axis.line.y = element_blank()) +   annotate("text", x = 0.4, y = 0.55, label = paste('Bird R² =', round(cutoff_comparison_50km$r2_df$r2[2], 3)), size=5) + annotate("text", x = 0.4, y = 0.65, label = paste('Mammal R² =', round(cutoff_comparison_50km$r2_df$r2[1], 3)), size=5) + theme(plot.title = element_text(face = "bold", hjust=0.5, size=16)))
...
# 25 km
cutoff_comparison_25km <- div_comparison(plant_cutoff_cell_FD_25km, mammal_cutoff_cell_FD_25km, bird_cutoff_cell_FD_25km, 25) 

cutoff_comparison_25km_plot <- cutoff_comparison_25km$plot
(cutoff_comparison_25km_plot <- cutoff_comparison_25km_plot + ylab('Frugivore FDis by cell') + xlab('Plant FDis by cell') + theme(axis.title.y = element_blank(),axis.text.y = element_blank(), axis.ticks.y = element_blank(), axis.line.y = element_blank()) +   annotate("text", x = 0.4, y = 0.55, label = paste('Bird R² =', round(cutoff_comparison_25km$r2_df$r2[2], 3)), size=5) + annotate("text", x = 0.4, y = 0.65, label = paste('Mammal R² =', round(cutoff_comparison_25km$r2_df$r2[1], 3)), size=5) + theme(plot.title = element_text(face = "bold", hjust=0.5, size=16)))
...
# 10 km
cutoff_comparison_10km <- div_comparison(plant_cutoff_cell_FD_10km, mammal_cutoff_cell_FD_10km, bird_cutoff_cell_FD_10km, 10) 

cutoff_comparison_10km_plot <- cutoff_comparison_10km$plot
(cutoff_comparison_10km_plot <- cutoff_comparison_10km_plot + ylab('Frugivore FDis by cell') + xlab('Plant FDis by cell') + theme(axis.title.y = element_blank(),axis.text.y = element_blank(), axis.ticks.y = element_blank(), axis.line.y = element_blank()) +   annotate("text", x = 0.4, y = 0.55, label = paste('Bird R² =', round(cutoff_comparison_10km$r2_df$r2[2], 3)), size=5) + annotate("text", x = 0.4, y = 0.65, label = paste('Mammal R² =', round(cutoff_comparison_10km$r2_df$r2[1], 3)), size=5) + theme(plot.title = element_text(face = "bold", hjust=0.5, size=16)))
...
# 5 km
cutoff_comparison_5km <- div_comparison(plant_cutoff_cell_FD_5km, mammal_cutoff_cell_FD_5km, bird_cutoff_cell_FD_5km, 5) 

cutoff_comparison_5km_plot <- cutoff_comparison_5km$plot
(cutoff_comparison_5km_plot <- cutoff_comparison_5km_plot + ylab('Frugivore FDis by cell') + xlab('Plant FDis by cell') + theme(axis.title.y = element_blank(),axis.text.y = element_blank(), axis.ticks.y = element_blank(), axis.line.y = element_blank()) +   annotate("text", x = 0.4, y = 0.55, label = paste('Bird R² =', round(cutoff_comparison_5km$r2_df$r2[2], 3)), size=5) + annotate("text", x = 0.4, y = 0.65, label = paste('Mammal R² =', round(cutoff_comparison_5km$r2_df$r2[1], 3)), size=5) + theme(plot.title = element_text(face = "bold", hjust=0.5, size=16)))
...
ggsave(paste0('all_taxa_', cutoff_obs, '_FDis_plots.png'), all_taxa_cutoff_FDis_plots, path = filtered_data_figure_path, width = 13, height = 8, units = "in", dpi=1000)


#### GAMs ####

# 100km
cutoff_comparison_100km_gam <- div_comparison_gam(plant_cutoff_cell_FD_100km, mammal_cutoff_cell_FD_100km, bird_cutoff_cell_FD_100km, 100)

cutoff_comparison_100km_gam_plot <- cutoff_comparison_100km_gam$plot
(cutoff_comparison_100km_gam_plot <- cutoff_comparison_100km_gam_plot + ylab('Frugivore FDis by cell') + xlab('Plant FDis by cell') + theme(axis.title.y = element_blank(),axis.text.y = element_blank(), axis.ticks.y = element_blank(), axis.line.y = element_blank()) +   annotate("text", x = 0.4, y = 0.55, label = paste('Bird D² =', round(cutoff_comparison_100km_gam$r2_df$dev_expl[2], 3)), size=5) + annotate("text", x = 0.4, y = 0.65, label = paste('Mammal D² =', round(cutoff_comparison_100km_gam$r2_df$dev_expl[1], 3)), size=5) + theme(plot.title = element_text(face = "bold", hjust=0.5, size=16)))
...
# 75 km
cutoff_comparison_75km_gam <- div_comparison_gam(plant_cutoff_cell_FD_75km, mammal_cutoff_cell_FD_75km, bird_cutoff_cell_FD_75km, 75)

cutoff_comparison_75km_gam_plot <- cutoff_comparison_75km_gam$plot
(cutoff_comparison_75km_gam_plot <- cutoff_comparison_75km_gam_plot + ylab('Frugivore FDis by cell') + xlab('Plant FDis by cell') + theme(axis.title.y = element_blank(),axis.text.y = element_blank(), axis.ticks.y = element_blank(), axis.line.y = element_blank()) +   annotate("text", x = 0.4, y = 0.55, label = paste('Bird D² =', round(cutoff_comparison_75km_gam$r2_df$dev_expl[2], 3)), size=5) + annotate("text", x = 0.4, y = 0.65, label = paste('Mammal D² =', round(cutoff_comparison_75km_gam$r2_df$dev_expl[1], 3)), size=5) + theme(plot.title = element_text(face = "bold", hjust=0.5, size=16)))
...
# 50 km
cutoff_comparison_50km_gam <- div_comparison_gam(plant_cutoff_cell_FD_50km, mammal_cutoff_cell_FD_50km, bird_cutoff_cell_FD_50km, 50)

cutoff_comparison_50km_gam_plot <- cutoff_comparison_50km_gam$plot
(cutoff_comparison_50km_gam_plot <- cutoff_comparison_50km_gam_plot + ylab('Frugivore FDis by cell') + xlab('Plant FDis by cell') + theme(axis.title.y = element_blank(),axis.text.y = element_blank(), axis.ticks.y = element_blank(), axis.line.y = element_blank()) +   annotate("text", x = 0.4, y = 0.55, label = paste('Bird D² =', round(cutoff_comparison_50km_gam$r2_df$dev_expl[2], 3)), size=5) + annotate("text", x = 0.4, y = 0.65, label = paste('Mammal D² =', round(cutoff_comparison_50km_gam$r2_df$dev_expl[1], 3)), size=5) + theme(plot.title = element_text(face = "bold", hjust=0.5, size=16)))
...
# 25 km
cutoff_comparison_25km_gam <- div_comparison_gam(plant_cutoff_cell_FD_25km, mammal_cutoff_cell_FD_25km, bird_cutoff_cell_FD_25km, 25)

cutoff_comparison_25km_gam_plot <- cutoff_comparison_25km_gam$plot
(cutoff_comparison_25km_gam_plot <- cutoff_comparison_25km_gam_plot + ylab('Frugivore FDis by cell') + xlab('Plant FDis by cell') + theme(axis.title.y = element_blank(),axis.text.y = element_blank(), axis.ticks.y = element_blank(), axis.line.y = element_blank()) +   annotate("text", x = 0.4, y = 0.55, label = paste('Bird D² =', round(cutoff_comparison_25km_gam$r2_df$dev_expl[2], 3)), size=5) + annotate("text", x = 0.4, y = 0.65, label = paste('Mammal D² =', round(cutoff_comparison_25km_gam$r2_df$dev_expl[1], 3)), size=5) + theme(plot.title = element_text(face = "bold", hjust=0.5, size=16)))
...
# 10 km
cutoff_comparison_10km_gam <- div_comparison_gam(plant_cutoff_cell_FD_10km, mammal_cutoff_cell_FD_10km, bird_cutoff_cell_FD_10km, 10)

cutoff_comparison_10km_gam_plot <- cutoff_comparison_10km_gam$plot
(cutoff_comparison_10km_gam_plot <- cutoff_comparison_10km_gam_plot + ylab('Frugivore FDis by cell') + xlab('Plant FDis by cell') + theme(axis.title.y = element_blank(),axis.text.y = element_blank(), axis.ticks.y = element_blank(), axis.line.y = element_blank()) +   annotate("text", x = 0.4, y = 0.55, label = paste('Bird D² =', round(cutoff_comparison_10km_gam$r2_df$dev_expl[2], 3)), size=5) + annotate("text", x = 0.4, y = 0.65, label = paste('Mammal D² =', round(cutoff_comparison_10km_gam$r2_df$dev_expl[1], 3)), size=5) + theme(plot.title = element_text(face = "bold", hjust=0.5, size=16)))
...
# 5 km
cutoff_comparison_5km_gam <- div_comparison_gam(plant_cutoff_cell_FD_5km, mammal_cutoff_cell_FD_5km, bird_cutoff_cell_FD_5km, 5)

cutoff_comparison_5km_gam_plot <- cutoff_comparison_5km_gam$plot
(cutoff_comparison_5km_gam_plot <- cutoff_comparison_5km_gam_plot + ylab('Frugivore FDis by cell') + xlab('Plant FDis by cell') + theme(axis.title.y = element_blank(),axis.text.y = element_blank(), axis.ticks.y = element_blank(), axis.line.y = element_blank()) +   annotate("text", x = 0.4, y = 0.55, label = paste('Bird D² =', round(cutoff_comparison_5km_gam$r2_df$dev_expl[2], 3)), size=5) + annotate("text", x = 0.4, y = 0.65, label = paste('Mammal D² =', round(cutoff_comparison_5km_gam$r2_df$dev_expl[1], 3)), size=5) + theme(plot.title = element_text(face = "bold", hjust=0.5, size=16)))
...
# combined plot
(all_taxa_cutoff_FDis_gam_plots <- wrap_plots(cutoff_comparison_5km_gam_plot, cutoff_comparison_10km_gam_plot, cutoff_comparison_25km_gam_plot, cutoff_comparison_50km_gam_plot, cutoff_comparison_75km_gam_plot, cutoff_comparison_100km_gam_plot, ncol=3, nrow=2) + plot_layout(guides='collect', axis_titles = 'collect') & theme(plot.margin = margin(5, 15, 15, 15),legend.position='bottom'))

ggsave(paste0('all_taxa_', cutoff_obs, '_FDis_gam_plots.png'), all_taxa_cutoff_FDis_gam_plots, path = filtered_data_figure_path, width = 13, height = 8, units = "in", dpi=1000)
