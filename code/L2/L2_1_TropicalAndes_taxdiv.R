...
all_plant_richness_plots <- ggpubr::ggarrange(plantgridRichTA_5km_labeled, plantgridRichTA_10km_labeled,
...
ggsave("plant_richness_plots2.png", all_plant_richness_plots_labeled, path = figure_path, width = 16, height = 5, units = "in", dpi=1000)
...
ggsave("frugivore_richness_plots3.png", all_frugivore_richness_plots_labeled, path = figure_path, width = 16, height = 5, units = "in", dpi=1000)
...
ggsave("mammal_richness_plots3.png", all_mammal_richness_plots_labeled, path = figure_path, width = 16, height = 5, units = "in")
...
ggsave("bird_richness_plots3.png", all_bird_richness_plots_labeled, path = figure_path, width = 16, height = 5, units = "in", dpi=1000)
