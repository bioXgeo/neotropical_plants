...
geom_sf(data = TApoly) +
#geom_raster(data = TropicalAndes_IUCNHabitat_Forest, aes(x = x, y = y, fill = fct_elevation_2), fill = "forestgreen") +
...
plantgridRichTA0.75 <-
  ...
  annotation_north_arrow(location = "bl", which_north = "true", 
  pad_x = unit(0.75, "in"), pad_y = unit(0.5, "in"), style = north_arrow_fancy_orienteering) +
  labs(title = "Tropical Andes Plant Richness", x = "Latitude", y = "Longitude", fill = "Number of species")
plantgridRichTA0.75
```
...
frugivoregridRichTA0.75 <-
  ...
  annotation_north_arrow(location = "bl", which_north = "true", 
  pad_x = unit(0.75, "in"), pad_y = unit(0.5, "in"), style = north_arrow_fancy_orienteering) +
  labs(title = "Tropical Andes Frugivore Richness", x = "Latitude", y = "Longitude", fill = "Number of species")
frugivoregridRichTA0.75
```
...
plot(plant_cellRichness0.75$num_species, frugivore_cellRichness0.75$num_species,
     main = "Plant Richness vs Frugivore Richness by cell",
