...
spatial_fdis_frugivore$cellid <- sapply(1:nrow(TAGrid_100km), function(i) {
  contains <- st_contains(TAGrid_100km[i, ], spatial_fdis_frugivore)
  cellid <- ifelse(any(contains), i, NA)
  return(cellid)
})
