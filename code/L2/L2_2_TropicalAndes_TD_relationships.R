...
library(dplyr); library(ggplot2); library(smoothr); library(purrr); library(ggtrendline); library(ggpubr); library(tidyr); library(patchwork); library(mgcv)
...
comparison_100km_plot <- comparison_100km_plot + ylab('Frugivore richness by cell') + xlab('Plant richness by cell') + theme(axis.title.y = element_blank(),axis.text.y = element_blank(), axis.ticks.y = element_blank(), axis.line.y = element_blank()) +   annotate("text", x = 1200, y = 380, label = paste('R² =', comparison_100km$mammal$R.squared), size=5) + annotate("text", x = 1200, y = 120, label = paste('R² =', comparison_100km$bird$R.squared), size=5) + theme(plot.title = element_text(face = "bold", hjust=0.5, size=16))
...
comparison_75km_plot <- comparison_75km_plot + ylab('Frugivore richness by cell') + xlab('Plant richness by cell') + theme(axis.title.y = element_blank(),axis.text.y = element_blank(), axis.ticks.y = element_blank(), axis.line.y = element_blank()) +   annotate("text", x = 1200, y = 380, label = paste('R² =', comparison_75km$mammal$R.squared), size=5) + annotate("text", x = 1200, y = 120, label = paste('R² =', comparison_75km$bird$R.squared), size=5) + theme(plot.title = element_text(face = "bold", hjust=0.5, size=16))
...
comparison_50km_plot <- comparison_50km_plot + ylab('Frugivore richness by cell') + xlab('Plant richness by cell') + annotate("text", x = 1200, y = 380, label = paste('R² =', comparison_50km$mammal$R.squared), size=5) + annotate("text", x = 1200, y = 120, label = paste('R² =', comparison_50km$bird$R.squared), size=5) + theme(plot.title = element_text(face = "bold", hjust=0.5, size=16))
...
comparison_25km_plot <- comparison_25km_plot + ylab('Frugivore richness by cell') + xlab('Plant richness by cell') + theme(axis.title.x = element_blank(),axis.text.x = element_blank(), axis.ticks.x = element_blank(), axis.line.x = element_blank(), axis.title.y = element_blank(),axis.text.y = element_blank(), axis.ticks.y = element_blank(), axis.line.y = element_blank()) + annotate("text", x = 900, y = 350, label = paste('R² =', comparison_25km$mammal$R.squared), size=5) + annotate("text", x = 900, y = 80, label = paste('R² =', comparison_25km$bird$R.squared), size=5)+ theme(plot.title = element_text(face = "bold", hjust=0.5, size=16))
...
comparison_10km_plot <- comparison_10km_plot + ylab('Frugivore richness by cell') + xlab('Plant richness by cell') + theme(axis.title.x = element_blank(),axis.text.x = element_blank(), axis.ticks.x = element_blank(), axis.line.x = element_blank(), axis.title.y = element_blank(),axis.text.y = element_blank(), axis.ticks.y = element_blank(), axis.line.y = element_blank()) + annotate("text", x = 700, y = 350, label = paste('R² =', comparison_10km$mammal$R.squared), size=5) + annotate("text", x = 700, y = 50, label = paste('R² =', comparison_10km$bird$R.squared), size=5) + theme(plot.title = element_text(face = "bold", hjust=0.5, size=16))
...
comparison_5km_plot <- comparison_5km_plot + ylab('Frugivore richness by cell') + xlab('Plant richness by cell') + theme(axis.title.x = element_blank(),axis.text.x = element_blank(), axis.ticks.x = element_blank(), axis.line.x = element_blank()) + annotate("text", x = 570, y = 280, label = paste('R² =', comparison_5km$mammal$R.squared), size=5) + annotate("text", x = 570, y = 50, label = paste('R² =', comparison_5km$bird$R.squared), size=5) + theme(plot.title = element_text(face = "bold", hjust=0.5, size=16))
