...
Frug_mammal2 <- col_class(Frug_mammal2)
...
str(Frug_mammal)
all.equal(Frug_mammal, Frug_mammal2, check.attributes = FALSE)
attach(Frug_mammal)                            
...
all.equal(Frug_bird, Frug_bird2, check.attributes = FALSE)
attach(Frug_bird)                            
# The analyses below are basic descriptions of the variables. After testing, they should be replaced.                 
...
all.equal(Frug_mammal_LookupTable, Frug_mammal_LookupTable2, check.attributes = FALSE)
...
all.equal(Frug_bird_LookupTable, Frug_bird_LookupTable2, check.attributes = FALSE)
