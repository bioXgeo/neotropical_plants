...
# Convert to sf
```{r}
TA_iucn_habitat_forest_shape <- rasterToPolygons(TA_iucn_habitat_forest, na.rm = TRUE, dissolve = TRUE)
```
...
# Save shapefile
```{r}
shapefile(TA_iucn_habitat_forest_shape, filename = file.path(output_path, "TropicalAndes_IUCNHabitat_Forest.shp"), overwrite=TRUE)
```
