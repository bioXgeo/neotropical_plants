...
# Aggregate to 0.3
```{r}
TropicalAndes_IUCNHabitat_Forest0.3 <- aggregate(TropicalAndes_IUCNHabitat_Forest, 30, fun=mean, na.rm=TRUE)
TropicalAndes_IUCNHabitat_Forest0.3
```

```{r}
writeRaster(TropicalAndes_IUCNHabitat_Forest0.3,file.path(output_path, "TropicalAndes_IUCNHabitat_Forest0.3.tif"), overwrite = TRUE)
```
