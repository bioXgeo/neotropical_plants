...
```{r}
# convert numberic traits into characters so we can combine into one dataframe
...
GIFT_traits <- dplyr::bind_rows(height_mean, height_min, height_max, lifespan, dispersal_syndrome_1, dispersal_syndrome_2, fruit_type, fruit_dryness, fruit_length_mean, fruit_length_min, fruit_length_max, seed_mass_mean, seed_mass_min, seed_mass_max, seed_length_mean, seed_length_min, seed_length_max, seed_width_mean, seed_width_min, seed_width_max)
```
