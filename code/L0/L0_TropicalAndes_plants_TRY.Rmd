...
# Load TRY data
Data was obtained from https://www.try-db.org/TryWeb/Prop0.php on 2024-09-09
```{r}
try_data <- rtry_import("G:/Shared drives/SpaCE_Lab_FRUGIVORIA/data/plants/L0/TRY/43808_09092025071012/43808.txt")
```
