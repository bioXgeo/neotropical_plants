...
create_presence_absence_matrix <- function(resolution_meters, species_sf) {
  ...
  species_grid <- TAGrid %>%
    ...
    dplyr::select(cellid, longitude, latitude, species)
  ...
  presence_absence_matrix <- species_grid %>%
    ...
    arrange(cellid) %>%
    dplyr::select(cellid, longitude, latitude, everything())

  # Convert to matrix and set row names
  presence_absence_matrix <- as.data.frame(presence_absence_matrix)
  rownames(presence_absence_matrix) <- presence_absence_matrix$cellid
