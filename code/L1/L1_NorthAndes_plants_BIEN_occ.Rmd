---
title: "Ecuador plant species BIEN occurrence cleaning"
author: "Hazel J. Anderson"
collaborators: "None"
data input: "Ecuador_BIEN_occurrence.csv"
data output: "Ecuador_BIEN_plant_occ_cleaned.csv", "Ecuador_BIEN_plant_occ_unresolved.csv"
project: "Frugivoria"
date: "2022-10-10"
...
config <- read.csv(file.path(output_path,"Ecuador_plant_BIEN_occ_ConfigurationTable"))
...
ecuador_BIEN_plant_occ_cleaned_path <- file.path(output_path,"Ecuador_BIEN_plant_occ_cleaned.csv")
write.csv(output, file = ecuador_BIEN_plant_occ_cleaned_path)
ecuador_BIEN_plant_occ_unresolved_path <- file.path(output_path,"Ecuador_BIEN_plant_occ_unresolved.csv")
write.csv(unresolved_names, file = ecuador_BIEN_plant_occ_unresolved_path)
```
