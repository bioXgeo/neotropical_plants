...
```{r}
averagetraits_fruitType$TraitValue <- as.factor(averagetraits_fruitType$TraitValue)
summary(averagetraits_fruitType)
```

```{r}
fruiting_species <- averagetraits_fruitType$Accepted_species
```
