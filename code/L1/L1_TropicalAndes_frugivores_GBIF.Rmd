...
```{r}
table(TropicalAndes_GBIF_frugivore_occ_cleaned$year)
```

```{r}
# remove records from before second world war
TropicalAndes_GBIF_frugivore_occ_cleaned <- TropicalAndes_GBIF_frugivore_occ_cleaned %>%
  filter(year > 1945) 
```
...
nrow(TropicalAndes_GBIF_frugivore_occ_cleaned)
print("The number of species is")
length(unique(TropicalAndes_GBIF_frugivore_occ_cleaned$species))
print("The number of families is")
length(unique(TropicalAndes_GBIF_frugivore_occ_cleaned$family))
```
