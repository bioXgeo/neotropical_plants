...
```{r}
#update col names
colnames(species_col_accepted) <- c("Name_submitted", "Name_matched", "Source")
colnames(species_col_synonmyn) <- c("Name_submitted", "Name_matched", "Source")
```
...
# replace species with lookup_table$Name_matched
